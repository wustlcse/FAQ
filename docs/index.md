...
8 CSE 542S: Concurrency and Memory Safe System Software Development: CSE and ESE PhD students have the highest priority, then CSE students in degrees that accept the course for degree credit (in waitlist order), then, space permitting, anyone else (in waitlist order).
