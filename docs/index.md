...
* CSE 231S Intro. to Parallel and Concurrent Programming:  Priority is given to students in CSE degree programs that accept this course as an elective for the degree program.  Majors will be given priority over Minors. Some priority is also given to students who have been waitlisted in prior semesters. 
